    ...
    cases: [
      {
        ...
        youtubeId: 'blE_bkxkk4U', isPro: true, duration: '0:28',
        ...
        galleryIds: ['zlqX7vghHSs', 'K8PcNsQyEMs', 'lbPF1cufito'],
      },
      {
        ...
        youtubeId: 'zlqX7vghHSs', isPro: false, duration: '0:35',
        ...
        galleryIds: ['blE_bkxkk4U', 'K8PcNsQyEMs', 'eg35evUinI4'],
      },
      {
        ...
        youtubeId: 'K8PcNsQyEMs', isPro: true, duration: '0:22',
        ...
        galleryIds: ['blE_bkxkk4U', 'zlqX7vghHSs', 'lbPF1cufito'],
      },
      {
        id: 'r4', title: 'Beauty контент — серия',
        creator: 'Nilufar Rashidova', initials: 'NR', avatarColor: '#5C4A3A',
        spec: 'Мобилограф', views: '89K', viewsNum: 89,
        youtubeId: 'lbPF1cufito', isPro: true, duration: '0:31',
        ...
        galleryIds: ['K8PcNsQyEMs', 'zlqX7vghHSs', 'blE_bkxkk4U'],
      },
      {
        id: 'r5', title: 'Кафе атмосфера — промо',
        creator: 'Feruza Nazarova', initials: 'FN', avatarColor: '#3A5C48',
        spec: 'Мобилограф', views: '88K', viewsNum: 88,
        youtubeId: 'eg35evUinI4', isPro: true, duration: '0:19',
        ...
        galleryIds: ['blE_bkxkk4U', 'lbPF1cufito', 'zlqX7vghHSs'],
      },
    ],
  },
  {
